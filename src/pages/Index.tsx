      ...
      <main className="flex-grow">
        ...
        <div className="bg-gradient-to-r from-nike-black to-gray-800 text-white py-3 px-6 text-center">
          <div className="container mx-auto flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4">
            ...
            <button 
              className="text-sm font-medium underline flex items-center hover:text-nike-red transition-colors"
        ...
        <section className="py-24 bg-gradient-to-b from-white to-gray-100 animate-section">
        ...
        {/* CTA Section */}
        <section className="py-20 bg-nike-black text-white animate-section">
          <div className="container mx-auto text-center container-padding">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                ...
                size="lg"
                onClick={() => navigate('/ar-vr')}
                className="text-white border-white hover:bg-white hover:text-nike-black"
              >
                Try in AR
              </Button>
            </div>
